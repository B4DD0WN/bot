...
*/
const B4DD0WN = '⚡⌁B4DD0WN BOT⌁⚡'; // JANGAN UBAH-UBAH INFO!!!
const instagram = 'https://instagram.com/dk_tog'; // JANGAN UBAH-UBAH INFO!!!
const nomer = 'Wa.me/+62812-3029-2051'; // JANGAN UBAH-UBAH INFO!!!
const aktif = 'Tergantung Kuota Selagi Ada Yang Donasi Pasti On Terus'; // JANGAN UBAH-UBAH INFO!!!
const groupwhatsapp = 'https://chat.whatsapp.com/DL0P36dstcR5zb0E7oNOp5'; // JANGAN UBAH-UBAH INFO!!!
const youtube = 'B4DD0WN BOT'; // JANGAN UBAH-UBAH INFO!!!
//B4DD0WN
...
const B4DD0WN1 = require("./lib/nzul1.js");
const B4DD0WN2 = require("./lib/nzul2.js");
const B4DD0WN3 = require("./lib/nzul3.js");
const B4DD0WN4 = require("./lib/nzul4.js");
const menuall = require("./lib/menuall.js");
const copas = require("./lib/copas.js");
const B4DD0WN = require("./lib/B4DD0WN.js");
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] B4DD0WN ready scan now!`);
});
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by B4DD0WN`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by B4DD0WN`)
})
...
conn.sendMessage(id, ' *Owner B4DD0WN* ' ,MessageType.text);
}
else if (text == '#menuall'){
...
conn.sendMessage(id, ' *Creator B4DD0WNGans* ' ,MessageType.text);
}
else if (text == '!menu'){
conn.sendMessage(id, ' *Perintah Memanggil Bot Salah* ' ,MessageType.text);
}
...
conn.sendMessage(id, nzul.nzul(id, B4DD0WN, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp, youtube) ,MessageType.text);
}
if (text == '#menu1'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, nzul1.nzul1(id, B4DD0WN, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp, youtube) ,MessageType.text);
}
if (text == '?copas'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, copas.copas(id, B4DD0WN, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp, youtube) ,MessageType.text);
}
if (text == '#menu2'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, nzul2.nzul2(id, B4DD0WN, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp, youtube) ,MessageType.text);
}
if (text == '#menu3'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, nzul3.nzul3(id, B4DD0WN, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp, youtube) ,MessageType.text);
}
if (text == '#menuall'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, menuall.menuall(id, B4DD0WN, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp, youtube) ,MessageType.text);
}
if (text == '#S&K'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, B4DD0WN.B4DD0WN(id, B4DD0WN, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp, youtube) ,MessageType.text);
}
if (text == '#menu4'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, nzul4.nzul4(id, B4DD0WN, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp, youtube) ,MessageType.text);
}
else if (text == '#donate'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, donate.donate(id, B4DD0WN, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp, youtube) ,MessageType.text);
}
else if (text == '#donasi'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, info.info(id, B4DD0WN, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp, youtube) ,MessageType.text);
}
else if (text == '!foto'){
conn.sendMessage(id, 'kirim !foto cewek/cowok\n\nContoh: !foto cewek' ,MessageType.text);
}
else if (text == '#help'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾B4DD0WN BOT👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/r00t_xnzul' ,MessageType.text);
}
else if (text == '#menu1'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾B4DD0WN BOT👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/r00t_xnzul' ,MessageType.text);
}
...
//Tolonglah bro jangan di ubah ubah B4DD0WN gans lu buriq tq
